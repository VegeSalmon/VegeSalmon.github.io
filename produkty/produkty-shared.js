(function() {
    const aside = document.getElementById('produktyAside');
    const toggle = document.getElementById('kategorieToggle');
    const overlay = document.getElementById('produktyAsideOverlay');
    const closeBtn = document.getElementById('produktyAsideClose');
...
(function() {
    ...
    const pag = document.getElementById('produktyPagination');
    function rerender() {
